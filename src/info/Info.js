...
export const info = {
    firstName: "Prabhjot",
    lastName: "Singh",
    initials: "PS", // the example uses first and last, but feel free to use three or more if you like.
    ...
    socials: [
        ...
        {
            link: "https://instagram.com/ijotprabh/",
